...
<head>
    ...
    <link href="view/bs-siminta-admin/assets/plugins/bootstrap/bootstrap.css" rel="stylesheet" />
    <link href="view/bs-siminta-admin/assets/font-awesome/css/font-awesome.css" rel="stylesheet" />
    <link href="view/bs-siminta-admin/assets/plugins/pace/pace-theme-big-counter.css" rel="stylesheet" />
    <link href="view/bs-siminta-admin/assets/css/style.css" rel="stylesheet" />
    <link href="view/bs-siminta-admin/assets/css/main-style.css" rel="stylesheet" />
    <!-- Page-Level CSS -->
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" id="navbar">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">
                <img src="resources/view/assets/img/logo.png" alt="" />
            </a>
        </div>
        <!-- end navbar-header -->
        <!-- navbar-top-links -->
                ...
                <li>
                    ...
                    <div class="user-section">
                        <div class="user-section-inner">
                            <img src="resources/view/assets/img/user.jpg" alt="">
                        </div>
                        <div class="user-info">
...
<script src="view/bs-siminta-admin/assets/plugins/jquery-1.10.2.js"></script>
<script src="view/bs-siminta-admin/assets/plugins/bootstrap/bootstrap.min.js"></script>
<script src="view/bs-siminta-admin/assets/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="view/bs-siminta-admin/assets/plugins/pace/pace.js"></script>
<script src="view/assets/scripts/siminta.js"></script>
<!-- Page-Level Plugin Scripts-->
<script src="view/bs-siminta-admin/assets/plugins/morris/raphael-2.1.0.min.js"></script>
<script src="view/bs-siminta-admin/assets/plugins/morris/morris.js"></script>
<script src="view/bs-siminta-admin/assets/scripts/dashboard-demo.js"></script>
